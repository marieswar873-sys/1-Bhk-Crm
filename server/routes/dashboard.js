...
router.get('/summary', authMiddleware, (req, res) => {
  const { from, to } = req.query; const dateFrom=from||istDate(); const dateTo=to||dateFrom;
...
router.get('/top-items', authMiddleware, (req, res) => {
  const { from, to, limit } = req.query; const dateFrom=from||istDate(); const dateTo=to||dateFrom;
